...
<body>
    <form action="bai2sekq.php" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
        ...
        <table class="table_checkbox">
            ...
            <tr>
            <td colspan="3">
                <textarea name="ad_inf" class="textarea-custom" placeholder="Type here"></textarea>
                </td>              
            </tr>
        </table>
